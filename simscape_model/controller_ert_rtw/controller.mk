...
## Generated on : Sat Mar 30 17:12:42 2024
...
START_DIR                 = C:/Users/danie/Documents/Dipterv_workspace/MechatronicSystem_Simulation/simscape_model
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = controller_comp.rsp
...
%.o : $(START_DIR)/controller_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/controller_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/controller_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
